...
- **[Observability](observability.md)** — keep stable operation context,
  correlation identifiers and W3C trace continuity across HTTP, workers and
  workflow/orchestrator boundaries without adding framework dependencies.
