...
- **🔭 Failure observability**: product-neutral operation context, W3C Trace Context continuity, OpenTelemetry attributes, Sentry enrichment, and dependency-free HTTP, worker, orchestrator, serverless and message-broker boundary adapters
